...
HD_PWD='C:/Users/STOVAG/Desktop/cpu_vga_ip_test/cpu_vga_top/cpu/cpu.runs/vga_controller_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_controller_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_controller_0.tcl
