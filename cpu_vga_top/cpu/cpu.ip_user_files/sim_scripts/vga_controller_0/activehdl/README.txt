...
#
# Generated by export_simulation on Tue Sep 05 20:44:50 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './vga_controller_0.sh' script.

./vga_controller_0.sh -reset_run
...
./vga_controller_0.sh -noclean_files

For more information on the script, please type './vga_controller_0.sh -help'.
