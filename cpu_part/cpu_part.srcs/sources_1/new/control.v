        ...
        case(op)
            ...
            6'b000000:begin
                case(func)
                    ...
                    6'b100000: opdec = {3'b001, 1'b1, 1'b0, 1'b0, 3'b010, 1'b0, 1'b0};   // sub
                    6'b100000: opdec = {3'b001, 1'b1, 1'b0, 1'b0, 3'b011, 1'b0, 1'b0};   // and
                    6'b100000: opdec = {3'b001, 1'b1, 1'b0, 1'b0, 3'b100, 1'b0, 1'b0};   // or
                    6'b100000: opdec = {3'b001, 1'b1, 1'b0, 1'b0, 3'b101, 1'b0, 1'b0};   // xor
                    // 
                    6'b100000: opdec = {3'b000, 1'b0, 1'b0, 1'b0, 3'b000, 1'b0, 1'b0};   // NULL
                endcase
            end
            // I
